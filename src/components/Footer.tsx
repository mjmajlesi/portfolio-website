    ...
    <div>
        <Container>
            <div className="flex items-center justify-between mb-5">
                <div className="flex flex-col items-start justify-start w-[700px] pr-3">
                ...
                <div className="w-[300px] flex items-center gap-5 mt-9">
                    <input type="search" className="max-w-[200px] h-9 bg-slate-600 rounded-lg p-3 focus:outline-none focus:outline-[#1e98d5]"  placeholder="Search..." />
